// this template copy from neu team : Vulpecula
// url : https://ac.nowcoder.com/acm/contest/view-submission?submissionId=63430764
// attention : this template need your c++17 or higher gcc
#include <bits/stdc++.h>
...
signed main() {
    ...
    out << "Running time is: "<< static_cast<double>(end_time-start_time) / CLOCKS_PER_SEC * 1000 << "ms\n";
#endif
    return 0;
}